  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const siemEvent: SiemEvent = {
        ...
        category: (threat as any).category,
        eventType: 'threat_detected',
        source: 'nexora',
        sourceIp: (threat as any).sourceIp || undefined,
        ...
        mitreTactics: (threat as any).mitreTactics ? (threat as any).mitreTactics.split(',') : undefined,
        mitreTechniques: (threat as any).mitreId ? [(threat as any).mitreId] : undefined,
        indicators: (threat as any).indicators ? JSON.parse((threat as any).indicators) : undefined,
      };
